...
import software.plusminus.crud.fixtures.ChildEntity;
import software.plusminus.crud.fixtures.TestCreateListener;
import software.plusminus.crud.fixtures.TestEntity;
import software.plusminus.crud.fixtures.TestReadListener;
import software.plusminus.crud.fixtures.TestWriteListener;
...
class CrudListenerContextTest {
    ...
    static Stream<Arguments> onCreate() {
        return Stream.of(
                Arguments.of(new Object(), false, false, null),
                Arguments.of(new TestEntity(), false, true, CrudAction.CREATE),
                Arguments.of(new ChildEntity(), false, true, CrudAction.CREATE)
        );
    }
}